# Salut, moi c'est Walide 👋

Étudiant en développement web à l'**EFREI**. Je conçois des applications web complètes, de la base de données jusqu'à l'interface.
...
| [**Memory Game**](https://github.com/Walidee27/Memory-game-) | Jeu de Memory avec 3 niveaux de difficulté, chronomètre et historique des scores | Vue 3 · Vite |
| [**Gestion de tâches**](https://github.com/Walidee27/Projet-Alpine.js-) | Gestionnaire de tâches avec statuts, filtres et recherche | Alpine.js · Tailwind |
| [**Todo List**](https://github.com/Walidee27/JS-TODO-LIST) | Liste de tâches avec échéances et import/export CSV | JavaScript vanilla |
